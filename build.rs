...
fn create_constants() {
    ...
    crc32.add_array("CASTAGNOLI_TABLE", "u32", &crc_core::make_table_crc32(CASTAGNOLI));

    let IEEE: u32 = 0xedb88320;
    crc32.add_value("IEEE", "u32", IEEE);
    crc32.add_array("IEEE_TABLE", "u32", &crc_core::make_table_crc32(IEEE));

    let KOOPMAN: u32 = 0xeb31d82e;
    crc32.add_value("KOOPMAN", "u32", KOOPMAN);
    crc32.add_array("KOOPMAN_TABLE", "u32", &crc_core::make_table_crc32(KOOPMAN));
    ...
    crc64.add_array("ECMA_TABLE", "u64", &crc_core::make_table_crc64(ECMA));

    let ISO: u64 = 0xd800000000000000;
    crc64.add_value("ISO", "u64", ISO);
    crc64.add_array("ISO_TABLE", "u64", &crc_core::make_table_crc64(ISO));
