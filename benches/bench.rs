...
pub const BLUETOOTH_NOLOOKUP: Crc<u8, Table<0>> = Crc::<u8, Table<0>>::new(&CRC_8_BLUETOOTH);
...
pub const X25_NOLOOKUP: Crc<u16, Table<0>> = Crc::<u16, Table<0>>::new(&CRC_16_IBM_SDLC);
...
pub const ISCSI_NOLOOKUP: Crc<u32, Table<0>> = Crc::<u32, Table<0>>::new(&CRC_32_ISCSI);
...
pub const ECMA_NOLOOKUP: Crc<u64, Table<0>> = Crc::<u64, Table<0>>::new(&CRC_64_ECMA_182);
...
pub const DARC_NOLOOKUP: Crc<u128, Table<0>> = Crc::<u128, Table<0>>::new(&CRC_82_DARC);
