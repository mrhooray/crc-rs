...
pub const ISCSI_SLICE16: Crc32Slice16 = Crc32Slice16::new(&CRC_32_ISCSI);
pub const ISCSI_BYTEWISE: Crc32Bytewise = Crc32Bytewise::new(&CRC_32_ISCSI);
pub const ISCSI_NOLOOKUP: Crc32Nolookup = Crc32Nolookup::new(&CRC_32_ISCSI);
